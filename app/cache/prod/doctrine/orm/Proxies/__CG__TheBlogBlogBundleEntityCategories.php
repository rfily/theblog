 ...
 */
class Categories extends \TheBlog\BlogBundle\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TheBlog\\BlogBundle\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'TheBlog\\BlogBundle\\Entity\\Categories' . "\0" . 'nom', '' . "\0" . 'TheBlog\\BlogBundle\\Entity\\Categories' . "\0" . 'article');
        }
