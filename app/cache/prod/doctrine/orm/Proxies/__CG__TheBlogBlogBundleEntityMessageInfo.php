 ...
 */
class MessageInfo extends \TheBlog\BlogBundle\Entity\MessageInfo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TheBlog\\BlogBundle\\Entity\\MessageInfo' . "\0" . 'id', '' . "\0" . 'TheBlog\\BlogBundle\\Entity\\MessageInfo' . "\0" . 'sender', '' . "\0" . 'TheBlog\\BlogBundle\\Entity\\MessageInfo' . "\0" . 'email', '' . "\0" . 'TheBlog\\BlogBundle\\Entity\\MessageInfo' . "\0" . 'message');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageInfo $proxy) {
